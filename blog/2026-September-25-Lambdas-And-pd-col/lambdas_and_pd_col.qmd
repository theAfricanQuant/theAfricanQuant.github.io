...
- Matt Harrison, [*Effective Pandas 3*](https://store.metasnake.com/effective-pandas-3-digital-book) (2026) — the pandas 3 edition of the chaining book this post borrows its style from; the `pd.col` idiom above is the one it teaches